...
window.WAPI.sendImage = function (imgBase64, chatid, filename, caption, done) {
    ...
    firstChat = Store.Chat.models[0];
    var originalID = firstChat.id;
    firstChat.id = typeof originalID === "string" ? chatid : new window.Store.UserConstructor(chatid, { intentionallyUsePrivateConstructor: true });

    return Store.Chat.find(originalID).then((chat) => {
