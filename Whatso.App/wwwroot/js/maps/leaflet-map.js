...
var LeafIcon = L.Icon.extend({
    options: {
        shadowUrl: '~/img/leaflet-shadow.png',
        iconSize:     [35, 41],
        shadowSize:   [35, 41],
        iconAnchor:   [22, 94],
        shadowAnchor: [20, 92],
...
var redIcon = new LeafIcon({iconUrl: '~/img/leaflet-red.png'}),
    blueIcon = new LeafIcon({iconUrl: '~/img/leaflet-blue.png'}),
    orangeIcon = new LeafIcon({iconUrl: '~/img/leaflet-orange.png'});
